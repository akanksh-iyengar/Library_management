...
<h2>Choose the corresponding author</h2>
<form name="addn1" action="Book_author_management_action2.jsp" method="post">
<table>
<tr>
  <td>Book_id:</td>
  <td><select name="bid">
...
<tr>
  ...
  <% Statement stmt1 = conn.createStatement();   
	String sql1 = "SELECT * from author where Category_id="+"\""+Sub+"\""+";";
	rs1 = stmt.executeQuery(sql1);
	while(rs1.next())
	{
		String fff1 = rs1.getString(1);
		String fff2 = rs1.getString(2);
		String fff3 = fff1+"("+fff2+")";
		out.println("<option>"+fff3+"</option>\n");
	}%>
</select>
</td>
</tr>
