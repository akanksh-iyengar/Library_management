...
<h2>Here is a list of existing books</h2>
<%!Connection conn; %>
<%!int idcount=0; %>
...
String f1= request.getParameter("bname");
...
<p></p>
<p></p>
<form name="addn_action1" action="Book_addn_new.jsp" method="post">
<table>
<tr>
<td><input type="submit" value="Add a new book"></td>
</tr>
</form>
</table>
