...
<h1>View your books and their respective authors</h1>
<%!Connection conn; %>
<%!int idcount=0; %>
...
String f2= request.getParameter("auid");
String Sub1,Sub2;
Sub1=f1.substring(0,5);
Sub2=f2.substring(0, 1);
ps=conn.prepareStatement("insert into book_author values(?,?)");
ps.setString(1, Sub1);
ps.setString(2, Sub2);
...
String sql1 = "SELECT * from book_author";
...
<p></p>
<p></p>
<form name="addn_action1" action="Book_author_management.jsp" method="post">
<table>
<tr>
