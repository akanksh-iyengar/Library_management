...
<form name="addn1" action="Rent_a_book_action3b.jsp" method="post">
<table>
<tr>
  <td>Book_id:</td>
  <td><select name="bid">
...
String Sub;
Sub=f1.substring(0,1);
Statement stmt = conn.createStatement();   
	String sql = "SELECT * from book,book_author where book.Book_id=book_author.Book_id && Author_id="+Sub+";";
